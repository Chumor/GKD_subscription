...
|ChatGPT|4|<li>通知提示-套餐限额提示<li>功能类-ban话题提前阻断屏蔽<li>局部广告<li>通知提示-聊天记忆容量警告|
...
|FlowMark|1|<li>更新提示|
|GitHub|2|<li>功能类-自动关闭登录批准结果<li>功能类-PR自动展开详情|
...
|Telegram|7|<li>权限提示-通知权限<li>其他-添加生日提示<li>局部广告-拍卖提示<li>其他-首页公告栏<li>权限提示-通讯录权限<li>功能类-更多-保存到相册<li>功能类-只保存单个媒体|
|Telegram|2|<li>更新提示<li>其他-添加生日提示|
...
|抖音|20|<li>开屏广告<li>局部广告<li>更新提示-关闭更新弹窗<li>权限提示-通知权限<li>功能类-自动勾选原图<li>其他-休息提醒<li>全屏广告-小组件弹窗<li>全屏广告<li>权限提示-通讯录权限<li>青少年模式<li>权限提示-定位权限<li>全屏广告-汽水音乐VIP<li>其他-个性化推荐弹窗<li>全屏广告-视频推荐广告<li>功能类-自动领取别人发的红包<li>功能类-自动抢口令红包<li>权限提示-相机权限<li>功能类-自动展开评论<li>功能类-自动展开评论_全部<li>其他-直播间小黄车|
...
|汽水音乐|9|<li>开屏广告<li>更新提示<li>全屏广告-VIP弹窗<li>功能类-全自动看广告领VIP<li>功能类-关闭广告的声音<li>评价提示-评分弹窗<li>局部广告-悬浮窗广告<li>其他-关闭[更多直播]推荐<li>功能类-全自动看广告领VIP_单日|
...
|山香网校|1|<li>开屏广告|
|闪动校园|1|<li>全屏广告|
|赏帮赚|2|<li>功能类-取消报名直接确认<li>功能类-上传自动选择截图|
...
|闲鱼|9|<li>权限提示-通知权限<li>权限提示-手机信息权限<li>更新提示<li>全屏广告<li>功能类-自动点击[查看原图]<li>功能类-关闭小额免密支付<li>功能类-Web登录自动授权<li>局部广告<li>局部广告-悬浮广告|
