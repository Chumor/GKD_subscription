...
[![Release](https://img.shields.io/badge/发行版-v462-blue)](https://github.com/Lin-arm/GKD_subscription/releases/latest)
[![已适配应用](https://img.shields.io/badge/已适配应用-926-brightgreen)](./dist/README.md#应用规则)
[![全局规则组](https://img.shields.io/badge/全局规则组-3-blueviolet)](./dist/README.md#全局规则)
[![应用规则组](https://img.shields.io/badge/应用规则组-2230-orange)](./dist/README.md#应用规则)
...
选择适合你的订阅源，复制到 GKD 订阅的右下角 **+** 号那里导入，即可使用
...
<!-- > 当前版本: v462
> 
> 当前订阅文件已适配 926 个应用，共有 2230 应用规则组，3 全局规则组
> 
...
![img](https://contrib.rocks/image?repo=Lin-arm/GKD_subscription&max=200&_v=462)
